...
export async function registerCommands(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-code-assistant.startChat', () => {
            vscode.commands.executeCommand('workbench.view.extension.ai-code-assistant');
        })
    );

    // Configure Provider Command
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-code-assistant.configureProvider', async () => {
            try {
                await vscode.commands.executeCommand('workbench.view.extension.ai-code-assistant');
                // Focus settings view
                ...
                vscode.window.showErrorMessage('Failed to open AI provider configuration.');
            }
        })
    );
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-code-assistant.toggleVoiceInput', () => {
            vscode.window.showInformationMessage('Voice input feature coming soon!');
        })
    );
